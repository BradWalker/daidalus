...
public final class f {
    ...
    /**
     * Given a list of names that may include files or directories, return a
     * list of files that contains (1) all of the files in the original list and
     * (2) all files ending with ".txt" in directories from the original list.
     *
    ...
    /**
     * Platform-specific line separator. Most of the time, this shouldn't be
     * used
     */
     ...
     *
     * @param buffer the output sent by f.pln and f.p calls NOT THREAD SAFE
     */
    ...
    /**
     * Send string to the console with a "carriage return." Also flushes both
     * stdout and stderr
     *
    ...
    /**
     * Send a "carriage return" to the console. Also flushes both stdout and
     * stderr
     */
    ...
    /**
     * Format a position vector as a Euclidean position using default units of
     * [NM,NM,ft]
     *
     * @param v a vector
     * @return a string representation
    ...
    /**
     * Add leading zeros to a string representation of an integer. If the
     * integer is greater than the number of lead length, then just return the
     * integer as a string.
     *
     * <ul>
     * <li>FmLead(3,2) == 03
    ...
    public static String FmLead(int v, int minLength) {
        switch (minLength) {
            case 2:
                return Frm_2.format(v);
            case 3:
                return Frm_3.format(v);
            case 4:
                return Frm_4.format(v);
            case 5:
                return Frm_5.format(v);
            case 6:
                return Frm_6.format(v);
            case 7:
                return Frm_7.format(v);
            case 8:
                return Frm_8.format(v);
            case 9:
                return Frm_9.format(v);
            default:
    ...
    /**
     * String form of numeric value to the default precision
     * (Constants.get_output_precision())
     *
    ...
    /**
     * String form of numeric value to the indicated precision (overrides
     * Constants.get_output_precision())
     *
     * @param v value to print
    ...
    /**
     * String form of numeric value to the indicated precision (overrides
     * Constants.get_output_precision() and Constants.get_trailing_zeros())
     *
     * @param v value to print
     * @param precision number of fractional digits to include
     * @param includeTrailingZeros if true, include fractional trailing zeros,
     * if false, truncate fractional trailing zeros
     * @return
     */
    public static String FmPrecision(double v, int precision, boolean includeTrailingZeros) {
        ...
        switch (precision) {
            case 1:
                return (includeTrailingZeros ? Frm1 : Frmnz1).format(v);
            case 2:
                return (includeTrailingZeros ? Frm2 : Frmnz2).format(v);
            case 3:
                return (includeTrailingZeros ? Frm3 : Frmnz3).format(v);
            case 4:
                return (includeTrailingZeros ? Frm4 : Frmnz4).format(v);
            case 5:
                return (includeTrailingZeros ? Frm5 : Frmnz5).format(v);
            case 6:
                return (includeTrailingZeros ? Frm6 : Frmnz6).format(v);
            case 7:
                return (includeTrailingZeros ? Frm7 : Frmnz7).format(v);
            case 8:
                return (includeTrailingZeros ? Frm8 : Frmnz8).format(v);
            case 9:
                return (includeTrailingZeros ? Frm9 : Frmnz9).format(v);
            case 10:
                return (includeTrailingZeros ? Frm10 : Frmnz10).format(v);
            case 11:
                return (includeTrailingZeros ? Frm11 : Frmnz11).format(v);
            case 12:
                return (includeTrailingZeros ? Frm12 : Frmnz12).format(v);
            case 13:
                return (includeTrailingZeros ? Frm13 : Frmnz13).format(v);
            case 14:
                return (includeTrailingZeros ? Frm14 : Frmnz14).format(v);
            case 15:
                return (includeTrailingZeros ? Frm15 : Frmnz15).format(v);
            case 16:
                return (includeTrailingZeros ? Frm16 : Frmnz16).format(v);
            default:
                return Frm0.format(v);
        }
    }
    ...
    /**
     * Format the double value after converting into the given units. The
     * returned string has a given width and the value has the given number of
     * digits of precision.
     *
     * @param v value
     * @param units units
    ...
    /**
     * Format the double value. The returned string has a given width and the
     * value has the given number of digits of precision.
     *
     * @param v value
     * @param width width
     * @param precision digits of precision
    ...
    /**
     * Return a string that is of the given width, either buffered with spaces
     * at the end, or truncated.
     *
     * @param s
     * @param w
     * @return
     ...
     *
     * @param o
     * @param lines if true, then add newlines between Collection and Map
     * entries.
     * @return
     */
    ...
    /**
     * Crude word-wrapping algorithm, only breaks on spaces and newlines (or
     * words greater than 80 characters).
     *
    ...
    /**
     * Create a string with the contents of the given list of strings. Between
     * each string insert the delimiter.
     *
    ...
    /**
     * Create a string with the contents of the OutputList object. Between each
     * string insert the delimiter.
     *
    ...
    /**
     * Return a string representation of the data in this 1-dimensional array. A
    ...
    /**
     * Return a string representation of the data in this 2-dimensional table. A
     * newline is NOT added to the end.
     *
     * @param data data to make a string
     * @param unit the unit to convert the values to
    ...
    /**
     * Return a string representation of the data in this 3-dimensional table. A
     * newline is NOT added to the end.
     *
     * @param data data to make a string
     * @param unit the unit to convert the values to
    ...
    /**
     * Converts Unix line separators to platform line separator. Most of the
     * time, Java handles this seamlessly, but there are some places where this
     * is needed.
     *
     * @param str the string with Unix separators (\n)
     * @return a string with Unix separators replaced with the platform-specific
     * separators
     */
    ...
    /**
     * Return a set of spaces the same length as the given string (to facilitate
     * printing tables)
     *
